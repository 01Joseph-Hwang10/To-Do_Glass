...
function updateProfileForm(props) {
    ...
    return (
        <div className="rounded w-11/12 sm:w-3/4 lg:w-1/2 flex flex-col justify-center items-center mx-auto p-3" style={{backgroundColor:COLOR_FOURTH}}>
            <form className="w-11/12 sm:w-7/12 flex flex-col justify-center items-center" onSubmit={OnSubmit}>
            ...
            <div className="flex justify-center items-center w-11/12 sm:w-7/12 rounded h-10 p-2 text-gray-900 font-semibold text-lg bg-gray-300"><Link to={{pathname:`/${profile.id}/home`}}>Cancel</Link></div>
        </div>
    )
}
