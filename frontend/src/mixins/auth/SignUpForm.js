            ...
            <div className="flex flex-col" style={{minHeight:minHeight}}>
                ...
                <div className="mx-auto w-11/12 sm:w-1/2 2xl:w-1/3 rounded-lg p-2 flex flex-col items-center justify-center shadow-md" style={{backgroundColor:COLOR_FOURTH}}>
                    <form className="emailSignUp w-11/12 mx-auto space-y-2 py-5 flex flex-col justify-center items-center" onSubmit={onSubmit}>
                        <span className="emailSignUp__warning text-yellow-500 font-semibold text-justify">Because the site's domain is not capable for sending an email, flglance currently not able to solve your login problem in case of forgetting the password or miswriting email and/or password. Please be careful at writing down your infos. If you got serious problem related with login, please contact with the email which is at a bottom of the site.</span>
                        ...
                        <span className="emailSignUp__failed text-red-500 font-semibold text-center" style={{display:'none'}}>Sign Up Failed!! You may used already used email!!</span>
