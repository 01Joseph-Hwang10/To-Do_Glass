...
export default function ContainerSecond(props) {
    ...
    <div className="containerSecond flex flex-col lg:flex-row-reverse justify-around items-center space-y-10 lg:space-y-0 py-10 sm:py-16 border-b-2">
            ...
            <div className="figSecond__pinboard space-y-2 flex flex-col justify-center items-start rounded shadow-inner bg-blue-50">
                ...
                <div className="sm:p-2 w-full">
                    <div className="container flex w-full justify-start items-center p-1 sm:p-2 space-x-2 bg-blue-100 shadow-inner rounded">
                        ...
                        <div className="container__example rounded w-24 h-20 sm:w-32 sm:h-24 flex flex-col justify-start items-center shadow-md" style={{backgroundColor:COLOR_SIXTH}}>
                        ...
                        <div className="container__willCreate rounded w-24 h-20 sm:w-32 sm:h-24 flex flex-col justify-start items-center shadow-md" style={{backgroundColor:COLOR_SIXTH,display:'none'}}>
                            <div className="w-full flex items-start justify-center">
                                <div className="w-3/12 flex justify-center items-center"><button onClick={alertCheckOut} className="fas fa-trash p-1 rounded-3xl hover:bg-gray-300" style={{transition:'all .1 ease-in-out'}}></button></div>
                                <div className="w-6/12 bg-pink-200 rounded-b flex justify-center items-start"><button onMouseDown={alertCheckOut} className="fas fa-grip-lines-vertical text-center"></button></div>
                                <div className="w-3/12 flex justify-center items-center"><button onClick={alertCheckOut} className="rounded-3xl hover:bg-gray-300" style={{transition:'all .1 ease-in-out'}}><Important isImportant={false} /></button></div>
                        ...
                        <div className="container__form rounded w-24 h-20 sm:w-32 sm:h-24 flex justify-center items-center shadow-md" style={{backgroundColor:COLOR_SIXTH,display:'flex'}}>
                        ...
                        <div className="container__placeholder rounded w-24 h-20 sm:w-32 sm:h-24 flex justify-center items-center bg-green-300 shadow-md" style={{opacity:0,display:'block'}}>
