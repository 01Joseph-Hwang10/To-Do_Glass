...
export default function ContainerFirst(props) {
    ...
    return (
        ...
        <div className="containerFirst flex flex-col lg:flex-row justify-around items-center space-y-10 py-10 sm:pb-16 border-b-2">
            ...
            <div className="figFirst w-full px-1 sm:px-0 sm:w-auto flex justify-center items-start space-x-2">

                <div className="flex flex-col justify-start items-center">

                    <div className="w-full py-4 px-2 flex flex-col items-center mt-3 justify-center space-y-1 shadow-md rounded" style={{backgroundColor:COLOR_FOURTH}}>
                    ...
                    <div className="figFirst__projectCard w-full mt-2 px-2 flex justify-between items-center shadow-md rounded" style={{display:'none',backgroundColor:COLOR_FOURTH}}>
                    ...
                    <div className="figFirst__tryAgain w-full py-1 mt-2 rounded flex justify-between bg-green-300 shadow-md" style={{display:'none'}}>
                        <button onClick={figFirstTryAgain} className="bg-transparent z-10 text-center font-bold w-full py-px">Try Again</button>
                    </div>

                </div>

                <div className="figFirst__emptyPinboard h-72 w-64 flex justify-center items-center rounded p-4 shadow-inner" style={{backgroundColor:COLOR_FOURTH,display:'flex'}}>
                ...
                <div className="figFirst__pinboard space-y-2 flex w-64 flex-col w-64 justify-center items-start rounded shadow-inner bg-blue-50" style={{display:'none'}}>
                    ...
                    <div className="figFirst__pinboard__header w-full flex justify-between items-center px-2 pt-2 rounded bg-gradient-to-b from-blue-100 to-blue-50">
                        ...
                        <button onClick={alertCheckOut} className='fas fa-expand-alt pr-2'></button>
                    </div>
