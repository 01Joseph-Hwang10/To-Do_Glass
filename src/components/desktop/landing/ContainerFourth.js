...
export default function ContainerFourth() {
    ...
    return (
    <div className="containerFourth w-full flex flex-col lg:flex-row-reverse justify-around items-center space-y-10 lg:space-y-0 py-16 border-b-2">

        <div className="descriptionFourth flex flex-col justify-center items-start space-y-2 p-8 2xl:p-16 bg-gradient-to-b from-indigo-100 to-indigo-50 shadow-md">
