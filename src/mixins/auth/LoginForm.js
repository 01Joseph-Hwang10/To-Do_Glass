...
class LoginForm extends React.Component {
    ...
    render() {
        ...
        const onSubmit = (e) => {
            ...
            this.props.postLogin(post_data);
            email.value="";
            password.value="";
        };
        ...
        return (
            <div className="flex flex-col" style={{minHeight:'100vh'}}>
                ...
                <div className="mx-auto w-1/2 2xl:w-1/3 rounded-lg p-2 flex flex-col items-center justify-center shadow-md" style={{backgroundColor:COLOR_FOURTH}}>
